...
wav_file='exp/xvectors_test_20000/output.ark.utt'
utt2lang_file='data/test_20000_10s/utt2lang'
...
langID = ('SCT', 'USA',  'AUS',  'CAN', 'ENG',  'IRL',  'IND',  'PHL',  'PAK',  'ZAF',  'NGA',  'GBR',  'KOR', 'VNM', 'KEN', 'COL', 'BRA', 'FRA', 'MEX', 'EGY', 'ARG', 'TWN')
#langID = ('it', 'hi', 'jw', 'ko', 'pt', 'us', 'uk')
ID2ind = {'SCT':0, 'USA':1,  'AUS':2,  'CAN':3, 'ENG':4,  'IRL':5,  'IND':6,  'PHL':7,  'PAK':8,  'ZAF':9,  'NGA':10,  'GBR':11,  'KOR':12 , 'VNM':13,  'KEN':14,  'COL':15,  'BRA':16,  'FRA':17,  'MEX':18,  'EGY':19, 'ARG':20,  'TWN':21}
...
ind2ID = {0:'SCT', 1:'USA',  2:'AUS',  3:'CAN', 4:'ENG',  5:'IRL',  6:'IND',  7:'PHL',  8:'PAK',  9:'ZAF',  10:'NGA',  11:'GBR',  12:'KOR', 13:'VNM',  14:'KEN',  15:'COL',  16:'BRA',  17:'FRA',  18:'MEX',  19:'EGY', 29:'ARG',  21:'TWN'}
