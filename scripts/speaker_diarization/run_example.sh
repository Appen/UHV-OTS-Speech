...
for audio in $(ls /data6/VoxConverse/audio/)
do
      ...
      python VBx/predict.py --in-file-list exp/list.txt \
          --in-lab-dir /data6/VoxConverse/dev/data/single_channel/sad
          --in-wav-dir /data6/VoxConverse/audio \
      ...
      then
          # run dscore
          python dscore/score.py -r le/rttm/${filename}.rttm -s exp/${filename}.rttm --collar 0.25 --ignore_overlaps
      fi
done
